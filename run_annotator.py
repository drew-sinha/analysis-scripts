...
if __name__ == "__main__":
    ...
    timepoint_filters = [load_data.filter_excluded] #, elegant_filters.filter_live_animals, elegant_filters.filter_by_stage('adult'), elegant_filters.filter_after_timepoint('2019-02-02t1200')]
    ...
    expt_pos = load_data.scan_experiment_dir(expt_dir,
        channels=channels,
        timepoint_filter = lambda position_name, timepoint_name: position_name in experiment_annotations and timepoint_name in experiment_annotations[position_name][1])
    if show_masks:
